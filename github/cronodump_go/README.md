...
- ✅ Парсинг баз данных Cronos (файлы CroStru.dat, CroBank.dat)
- ✅ Транслитерация русских имен таблиц и полей в латиницу
- ✅ Анализ связей между таблицами (прямые, обратные, прямо-обратные ссылки)
- ✅ Объединение связанных таблиц в одну таблицу
- ✅ Экспорт в SQL файлы для ClickHouse
- ✅ Прямой импорт в ClickHouse
- ✅ Удаление временных файлов после импорта
